...
if __name__ == "__main__":
    ...
    #                0, 
    #                1,
    #                np.array([[150, 130]], dtype=np.float32),
    #                np.array([1], np.int32),
    #                save_dir=tmp_dir)
    ...
    #                0, 
    #                2,
    #                np.array([[280, 100]], dtype=np.float32),
    #                np.array([1], np.int32),
    #                save_dir=tmp_dir)
    # annotate_frame(predictor,
    #                0, 
    #                3,
    #                np.array([[280, 160]], dtype=np.float32),
    #                np.array([1], np.int32),
    #                save_dir=tmp_dir)
    ...
    #                0, 
    #                4,
    #                np.array([[400, 115]], dtype=np.float32),
    #                np.array([1], np.int32),
    #                save_dir=tmp_dir)
    # check the annotated points
    frame_idx = 0
